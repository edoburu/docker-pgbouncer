...
RUN \
  # Download
  apk --update add autoconf autoconf-doc automake udns-dev curl gcc libc-dev libevent libevent-dev libtool make man libressl-dev pkgconfig postgresql-client && \
